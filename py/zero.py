...
class Spider(Spider):
    ...
    headers={'User-Agent':'okhttp/5.1.0','client':'app','deviceType':'Android'}
    ...
    def detailContent(self,ids):
        ...
        vod = {
            ...
            'vod_director':'⚡️'+v.get('director')+'⚡️',
    ...
    def searchContent(self,key,quick,pg="1"):
        jdata={"condition":{"value":key},"pageNum":int(pg),"pageSize":40}
    ...
    def playerContent(self,flag,id,vipFlags):
        ...
        return  {'parse':p,'url':url,'header':{'User-Agent':'okhttp/5.1.0'}}
    ...
    def getlist(self,data):
        ...
        for i in data:
            videos.append({
                ...
                'vod_pic': i.get('cover'),
                'vod_year': i.get('year'),
                'vod_remarks': ('🌡️' + str(i.get('totalEpisode')) + '🌡️') if i.get('totalEpisode') else i.get('totalEpisode')
            })
        return videos
